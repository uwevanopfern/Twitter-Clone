...
//        FirebaseMessaging.getInstance().subscribeToTopic("news")
    ...
    fun SaveImageInFirebase(){
        ...
        val storgaRef=storage.getReferenceFromUrl("gs://faketwitter-23db6.appspot.com/")
        ...
        ivImagePerson.buildDrawingCache() //Have image

        val drawable=ivImagePerson.drawable as BitmapDrawable
        val bitmap=drawable.bitmap //reduce the size as bitmap
        val baos=ByteArrayOutputStream() //bytes of image
        bitmap.compress(Bitmap.CompressFormat.JPEG,100,baos) // take image and change it into bytes
        val data= baos.toByteArray() //get the image as bytes
